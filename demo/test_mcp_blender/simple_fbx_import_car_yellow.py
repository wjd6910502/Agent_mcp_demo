...
def simple_import_fbx(fbx_file_path):
    ...
    try:
        ...
        print("🎉 导入完成！")读取桌面上“test_mcp_blender"文件夹下的simple_fbx_import_car_yellow.py，读取内部内容，让blender按内容代码执行
        return True
...
# 设置文件路径
base_path = "/home/kylin/"
FBX_FILE_PATH =  base_path + "test_mcp_blender/models/model_bz_gls.fbx"
BLEND_FILE_PATH = base_path + "test_mcp_blender/material/yellow_black.blend"
